...
- Name: workflow.spec.ts >> Workflow Logistique 2030 >> devrait permettre de créer un nouveau projet
- Location: e2e/workflow.spec.ts:4:7
...
Call log:
  - waiting for getByRole('link', { name: 'NEW' })
